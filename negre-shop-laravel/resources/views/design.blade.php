...
@section('title', 'Design Mobilier - Frederic N\'DA')
...
<script>
    ...
    window.openOrderModal = function(index) {
        openOrderModalWithProduct(products[index]);
    }

    function openOrderModalWithProduct(product) {
        document.getElementById('product_id').value = product.id;
        document.getElementById('message').value = `Je souhaite commander la pièce "${product.name}" au prix de ${product.formatted_price || product.price + ' FCFA'}.`;
